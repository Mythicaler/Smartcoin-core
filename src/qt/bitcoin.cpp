...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        QMessageBox::critical(0, QObject::tr("smartcoin Core"), QObject::tr("Error: %1").arg(e.what()));
        return EXIT_FAILURE;
    }
#ifdef ENABLE_WALLET
    ...
    if(!smartnodeConfig.read(strErr)) {
        QMessageBox::critical(0, QObject::tr("smartcoin Core"),
    ...
    try
    {
        ...
        WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("smartcoin Core didn't yet exit safely..."), (HWND)app.getMainWinId());
#endif
        app.exec();
        app.requestShutdown();
        app.exec();

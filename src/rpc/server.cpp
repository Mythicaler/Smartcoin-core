...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    //{ "smartcoin",               "gobject",                &gobject,                true  },
    //{ "smartcoin",               "getgovernanceinfo",      &getgovernanceinfo,      true  },
    //{ "smartcoin",               "getsuperblockbudget",    &getsuperblockbudget,    true  },
    //{ "smartcoin",               "voteraw",                &voteraw,                true  },
    { "smartcoin",               "snsync",                 &snsync,                 true  },
    { "smartcoin",               "spork",                  &spork,                  true  },
    //{ "smartcoin",               "getpoolinfo",            &getpoolinfo,            true  },
    { "smartcoin",               "sentinelping",           &sentinelping,           true  },
#ifdef ENABLE_WALLET
    //{ "smartcoin",               "privatesend",            &privatesend,            false },
